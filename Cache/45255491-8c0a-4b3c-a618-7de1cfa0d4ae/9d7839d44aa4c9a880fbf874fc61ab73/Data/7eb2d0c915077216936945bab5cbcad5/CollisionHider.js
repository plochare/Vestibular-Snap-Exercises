...
let CollisionHider = (() => {
    ...
    var CollisionHider = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            ...
            let movingCollider = this.movingObject.getComponent("Component.ColliderComponent");
            if (!movingCollider) {
                print("Warning: Moving object does not have a ColliderComponent. Adding one.");
                movingCollider = this.movingObject.createComponent("Component.ColliderComponent");
            }
        ...
        getCollidersFromChildren(parent) {
    ...
    __setFunctionName(_classThis, "CollisionHider");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        CollisionHider = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CollisionHider = _classThis;
})();
exports.CollisionHider = CollisionHider;
