...
//float Port_Import_N118 7392
//float2 Port_Import_N119 7400
//float2 Port_Input1_N074 7416
//float Port_Input1_N075 7424
//float Port_Import_N157 7428
//float Port_Import_N159 7432
//float Port_Input1_N161 7436
//float Port_Input2_N161 7440
//}
...
float Port_Import_N118;
float2 Port_Import_N119;
float Port_AlphaTestThreshold_N039;
float2 Port_Input1_N074;
float Port_Input1_N075;
float Port_Import_N157;
float Port_Import_N159;
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/5000]!=0);
}
else
{
l9_46=l9_45;
...
main_vert_out out={};
int ssInstanceID=0;
int N120_FacingMode=0;
int N120_Alignment=0;
float N120_VelocityStretchAmount=0.0;
float2 N120_PivotPoint=float2(0.0);
sc_Vertex_t l9_0;
...
bool l9_4=l9_3>=(5000*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/5000]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/5000];
...
Value_N106=1.0;
float Value_N107=0.0;
Value_N107=0.0;
float Value_N118=0.0;
Value_N118=(*sc_set0.UserUniforms).Port_Import_N118;
float2 Value_N119=float2(0.0);
Value_N119=fast::clamp((*sc_set0.UserUniforms).Port_Import_N119,float2(-0.5),float2(0.5));
float param_4=Value_N106;
float param_5=Value_N107;
float param_6=Value_N118;
float2 param_7=Value_N119;
ssGlobals param_8=Globals;
ssGlobals tempGlobals=param_8;
N120_FacingMode=int(param_4);
N120_Alignment=int(param_5);
N120_VelocityStretchAmount=param_6;
N120_PivotPoint=param_7;
float l9_26=0.029999999;
float3 l9_27=float3(0.0,1.0,0.0);
float3 l9_28=gParticle.Velocity;
float l9_29=length(l9_28);
float l9_30=fast::max(l9_29*N120_VelocityStretchAmount,1.0);
if ((l9_29<l9_26)||(N120_VelocityStretchAmount<9.9999997e-05))
{
if (N120_Alignment==1)
{
int l9_31=0;
...
float2 l9_44=(l9_43-float2(0.5))+N120_PivotPoint;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/5000];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
param_1.Index1DPerCopy=param%5000;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(5000*((param/5000)+1))-1;
...
param_1.SpawnOffset=param_1.Ratio1D*0.5;
...
Value_N55=gParticle.Color;
float2 UVCoord_N62=float2(0.0);
UVCoord_N62=Globals.Surface_UVCoord0;
float Output_N74=0.0;
Output_N74=distance(UVCoord_N62,(*sc_set0.UserUniforms).Port_Input1_N074);
float Output_N75=0.0;
Output_N75=Output_N74*(*sc_set0.UserUniforms).Port_Input1_N075;
float Output_N76=0.0;
Output_N76=1.0-Output_N75;
float Value_N157=0.0;
Value_N157=(*sc_set0.UserUniforms).Port_Import_N157;
...
{
l9_24=pow(Output_N76,Value_N157);
}
Output_N158=l9_24;
float Value_N159=0.0;
Value_N159=(*sc_set0.UserUniforms).Port_Import_N159;
float Output_N160=0.0;
Output_N160=Output_N158*Value_N159;
float Output_N161=0.0;
Output_N161=fast::clamp(Output_N160+0.001,(*sc_set0.UserUniforms).Port_Input1_N161+0.001,(*sc_set0.UserUniforms).Port_Input2_N161+0.001)-0.001;
float Export_N162=0.0;
Export_N162=Output_N161;
float4 Output_N89=float4(0.0);
Output_N89=float4(1.0,1.0,1.0,Export_N162);
float4 Output_N163=float4(0.0);
Output_N163=Value_N55*Output_N89;
float4 param_2=Output_N163;
