...
//sampler sampler meshData0SmpSC 0:19
//sampler sampler meshData1SmpSC 0:20
//sampler sampler sc_ScreenTextureSmpSC 0:25
//texture texture2D intensityTexture 0:1:0:18
//texture texture2D meshData0 0:2:0:19
//texture texture2D meshData1 0:3:0:20
...
//}
//ubo int UserUniforms 0:28:4656 {
//float4 sc_Time 1376
...
//float3 objectBoundsMin 4256
//float3 objectBoundsMax 4272
//float3x3 meshData0Transform 4336
//float4 meshData0UvMinMax 4384
//float4 meshData0BorderColor 4400
//float3x3 meshData1Transform 4464
//float4 meshData1UvMinMax 4512
//float4 meshData1BorderColor 4528
//float2 Port_Input1_N001 4544
//float Port_Value2_N017 4552
//float Port_Value3_N017 4556
//float Port_RangeMinA_N016 4560
//float Port_RangeMaxA_N016 4564
//float Port_RangeMinB_N016 4568
//float Port_RangeMaxB_N016 4572
//float2 Port_Input1_N038 4592
//float Port_RangeMinA_N021 4640
//float Port_RangeMaxA_N021 4644
//float Port_RangeMinB_N021 4648
//float Port_RangeMaxB_N021 4652
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_meshData0 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_meshData1 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_MIN_MAX_meshData0 35 0
//spec_const bool SC_USE_UV_MIN_MAX_meshData1 36 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 37 0
//spec_const bool SC_USE_UV_TRANSFORM_meshData0 38 0
//spec_const bool SC_USE_UV_TRANSFORM_meshData1 39 0
//spec_const bool UseViewSpaceDepthVariant 40 1
//spec_const bool intensityTextureHasSwappedViews 41 0
//spec_const bool meshData0HasSwappedViews 42 0
//spec_const bool meshData1HasSwappedViews 43 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_meshData0 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_meshData1 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_meshData0 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_meshData1 79 -1
//spec_const int intensityTextureLayout 80 0
//spec_const int meshData0Layout 81 0
//spec_const int meshData1Layout 82 0
...
constant bool SC_USE_CLAMP_TO_BORDER_meshData0 [[function_constant(32)]];
...
constant bool SC_USE_CLAMP_TO_BORDER_meshData1 [[function_constant(33)]];
...
constant bool SC_USE_UV_MIN_MAX_meshData0 [[function_constant(35)]];
...
constant bool SC_USE_UV_MIN_MAX_meshData1 [[function_constant(36)]];
...
constant bool SC_USE_UV_TRANSFORM_meshData0 [[function_constant(38)]];
...
constant bool SC_USE_UV_TRANSFORM_meshData1 [[function_constant(39)]];
...
constant bool meshData0HasSwappedViews [[function_constant(42)]];
...
constant bool meshData1HasSwappedViews [[function_constant(43)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_meshData0 [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_meshData1 [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_meshData0 [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_meshData1 [[function_constant(79)]];
...
constant int meshData0Layout [[function_constant(81)]];
constant int meshData0Layout_tmp = is_function_constant_defined(meshData0Layout) ? meshData0Layout : 0;
constant int meshData1Layout [[function_constant(82)]];
...
float3 Port_Import_N019;
float2 Port_Input1_N038;
...
texture2d<float> meshData0 [[id(2)]];
texture2d<float> meshData1 [[id(3)]];
texture2d<float> sc_ScreenTexture [[id(15)]];
sampler intensityTextureSmpSC [[id(18)]];
sampler meshData0SmpSC [[id(19)]];
sampler meshData1SmpSC [[id(20)]];
...
Output_N1=UVCoord_N0*(*sc_set0.UserUniforms).Port_Input1_N001;
float2 Output_N2=float2(0.0);
Output_N2=Output_N1-float2(1.0);
float4 Value_N17=float4(0.0);
Value_N17=float4(Output_N2.x,Output_N2.y,Value_N17.z,Value_N17.w);
Value_N17.z=(*sc_set0.UserUniforms).Port_Value2_N017;
Value_N17.w=(*sc_set0.UserUniforms).Port_Value3_N017;
WorldPosition=Value_N17.xyz;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
...
l9_450=param_6.SurfacePosition_WorldSpace;
l9_449=l9_450;
out.Interpolator0.x=l9_449.x;
out.Interpolator0.y=l9_449.y;
out.Interpolator0.z=l9_449.z;
float3 param_7=out.varPosAndMotion.xyz;
if ((int(sc_MotionVectorsPass_tmp)!=0))
{
float4 l9_451=((*sc_set0.UserUniforms).sc_PrevFrameModelMatrix*(*sc_set0.UserUniforms).sc_ModelMatrixInverse)*float4(param_7,1.0);
float3 l9_452=param_7;
float3 l9_453=l9_451.xyz;
if ((int(sc_MotionVectorsPass_tmp)!=0))
{
int l9_454=0;
if (sc_StereoRenderingMode_tmp==0)
...
int l9_455=l9_454;
float4 l9_456=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_455]*float4(l9_452,1.0);
float2 l9_457=l9_456.xy/float2(l9_456.w);
l9_456=float4(l9_457.x,l9_457.y,l9_456.z,l9_456.w);
int l9_458=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_458=0;
...
int l9_459=l9_458;
float4 l9_460=(*sc_set0.UserUniforms).sc_PrevFrameViewProjectionMatrixArray[l9_459]*float4(l9_453,1.0);
float2 l9_461=l9_460.xy/float2(l9_460.w);
l9_460=float4(l9_461.x,l9_461.y,l9_460.z,l9_460.w);
float2 l9_462=(l9_456.xy-l9_460.xy)*0.5;
out.varPosAndMotion.w=l9_462.x;
out.varNormalAndMotion.w=l9_462.y;
}
}
...
float3 param;
param.x=in.Interpolator0.x;
param.y=in.Interpolator0.y;
param.z=in.Interpolator0.z;
Output_N7=param;
float Value1_N5=0.0;
float Value2_N5=0.0;
float3 param_1=Output_N7;
float param_2=param_1.x;
float param_3=param_1.y;
Value1_N5=param_2;
Value2_N5=param_3;
float3 Output_N9=float3(0.0);
float3 param_4=(*sc_set0.UserUniforms).objectBoundsMin;
Output_N9=param_4;
float Value1_N11=0.0;
float Value2_N11=0.0;
float3 param_5=Output_N9;
float param_6=param_5.x;
float param_7=param_5.y;
Value1_N11=param_6;
Value2_N11=param_7;
float3 Output_N10=float3(0.0);
float3 param_8=(*sc_set0.UserUniforms).objectBoundsMax;
Output_N10=param_8;
float Value1_N12=0.0;
float Value2_N12=0.0;
float3 param_9=Output_N10;
float param_10=param_9.x;
float param_11=param_9.y;
Value1_N12=param_10;
Value2_N12=param_11;
float4 Packed_N8=float4(0.0);
float param_12=Value1_N5;
float param_13=Value1_N11;
float param_14=Value1_N12;
float param_15=Value2_N5;
float param_16=Value2_N11;
float param_17=Value2_N12;
float l9_0=param_12;
float l9_1=param_13;
float l9_2=param_14;
float l9_3=0.99998999;
float l9_4=fast::clamp(l9_0,l9_1,l9_2);
float l9_5=l9_1;
float l9_6=l9_2;
float l9_7=0.0;
float l9_8=l9_3;
float l9_9=l9_7+(((l9_4-l9_5)*(l9_8-l9_7))/(l9_6-l9_5));
float l9_10=l9_9;
float4 l9_11=float4(1.0,255.0,65025.0,16581375.0)*l9_10;
l9_11=fract(l9_11);
l9_11-=(l9_11.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_12=l9_11.xy;
float2 l9_13=l9_12;
float4 param_18;
param_18=float4(l9_13.x,l9_13.y,param_18.z,param_18.w);
float l9_14=param_15;
float l9_15=param_16;
float l9_16=param_17;
float l9_17=0.99998999;
float l9_18=fast::clamp(l9_14,l9_15,l9_16);
float l9_19=l9_15;
float l9_20=l9_16;
float l9_21=0.0;
float l9_22=l9_17;
float l9_23=l9_21+(((l9_18-l9_19)*(l9_22-l9_21))/(l9_20-l9_19));
float l9_24=l9_23;
float4 l9_25=float4(1.0,255.0,65025.0,16581375.0)*l9_24;
l9_25=fract(l9_25);
l9_25-=(l9_25.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_26=l9_25.xy;
float2 l9_27=l9_26;
param_18=float4(param_18.x,param_18.y,l9_27.x,l9_27.y);
Packed_N8=param_18;
FinalColor=Packed_N8;
...
{
float4 l9_28=gl_FragCoord;
float2 l9_29=floor(mod(l9_28.xy,float2(4.0)));
float l9_30=(mod(dot(l9_29,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_19<l9_30)
{
discard_fragment();
}
}
float3 Output_N7_1=float3(0.0);
float3 param_20;
param_20.x=in.Interpolator0.x;
param_20.y=in.Interpolator0.y;
param_20.z=in.Interpolator0.z;
Output_N7_1=param_20;
float Value3_N5=0.0;
float3 param_21=Output_N7_1;
float param_22=param_21.z;
Value3_N5=param_22;
float3 Output_N9_1=float3(0.0);
float3 param_23=(*sc_set0.UserUniforms).objectBoundsMin;
Output_N9_1=param_23;
float Value3_N11=0.0;
float3 param_24=Output_N9_1;
float param_25=param_24.z;
Value3_N11=param_25;
float3 Output_N10_1=float3(0.0);
float3 param_26=(*sc_set0.UserUniforms).objectBoundsMax;
Output_N10_1=param_26;
float Value3_N12=0.0;
float3 param_27=Output_N10_1;
float param_28=param_27.z;
Value3_N12=param_28;
float2 Packed_N13=float2(0.0);
float param_29=Value3_N5;
float param_30=Value3_N11;
float param_31=Value3_N12;
float param_32=0.99998999;
float l9_31=fast::clamp(param_29,param_30,param_31);
float l9_32=param_30;
float l9_33=param_31;
float l9_34=0.0;
float l9_35=param_32;
float l9_36=l9_34+(((l9_31-l9_32)*(l9_35-l9_34))/(l9_33-l9_32));
float l9_37=l9_36;
float4 l9_38=float4(1.0,255.0,65025.0,16581375.0)*l9_37;
l9_38=fract(l9_38);
l9_38-=(l9_38.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_39=l9_38.xy;
float2 l9_40=l9_39;
Packed_N13=l9_40;
FinalColor1=float4(Packed_N13,0.0,0.0);
float3 Normal_N14=float3(0.0);
Normal_N14=Globals.VertexNormal_WorldSpace;
float3 Output_N15=float3(0.0);
float3 param_33=Normal_N14;
float l9_41=dot(param_33,param_33);
float l9_42;
if (l9_41>0.0)
{
...
float l9_43=l9_42;
float3 param_34=param_33*l9_43;
Output_N15=param_34;
float3 ValueOut_N16=float3(0.0);
ValueOut_N16=(((Output_N15-float3((*sc_set0.UserUniforms).Port_RangeMinA_N016))/float3(((*sc_set0.UserUniforms).Port_RangeMaxA_N016-(*sc_set0.UserUniforms).Port_RangeMinA_N016)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N016-(*sc_set0.UserUniforms).Port_RangeMinB_N016))+float3((*sc_set0.UserUniforms).Port_RangeMinB_N016);
FinalColor2=float4(ValueOut_N16,0.0);
float3 Output_N7_2=float3(0.0);
float3 param_35;
param_35.x=in.Interpolator0.x;
param_35.y=in.Interpolator0.y;
param_35.z=in.Interpolator0.z;
Output_N7_2=param_35;
float3 Value_N19=float3(0.0);
Value_N19=Output_N7_2;
float3 Position_N35=float3(0.0);
Position_N35=Globals.SurfacePosition_WorldSpace;
float2 Output_N36=float2(0.0);
Output_N36=float2(Position_N35.x,Position_N35.y);
float2 Output_N37=float2(0.0);
Output_N37=Output_N36+float2(1.0);
float2 Output_N38=float2(0.0);
Output_N38=Output_N37*(*sc_set0.UserUniforms).Port_Input1_N038;
float4 Color_N33=float4(0.0);
int l9_44;
...
int l9_49=l9_44;
int param_36=meshData0Layout_tmp;
int param_37=l9_49;
float2 param_38=Output_N38;
bool param_39=(int(SC_USE_UV_TRANSFORM_meshData0_tmp)!=0);
float3x3 param_40=(*sc_set0.UserUniforms).meshData0Transform;
int2 param_41=int2(SC_SOFTWARE_WRAP_MODE_U_meshData0_tmp,SC_SOFTWARE_WRAP_MODE_V_meshData0_tmp);
bool param_42=(int(SC_USE_UV_MIN_MAX_meshData0_tmp)!=0);
float4 param_43=(*sc_set0.UserUniforms).meshData0UvMinMax;
bool param_44=(int(SC_USE_CLAMP_TO_BORDER_meshData0_tmp)!=0);
float4 param_45=(*sc_set0.UserUniforms).meshData0BorderColor;
float param_46=0.0;
bool l9_50=param_44&&(!param_42);
float l9_51=1.0;
float l9_52=param_38.x;
int l9_53=param_41.x;
if (l9_53==1)
{
l9_52=fract(l9_52);
}
...
param_38.x=l9_52;
float l9_57=param_38.y;
int l9_58=param_41.y;
if (l9_58==1)
{
l9_57=fract(l9_57);
}
...
float l9_64=param_38.x;
float l9_65=param_43.x;
float l9_66=param_43.z;
bool l9_67=l9_63;
float l9_68=l9_51;
...
float l9_73=param_38.y;
float l9_74=param_43.y;
float l9_75=param_43.w;
bool l9_76=l9_72;
float l9_77=l9_51;
...
float2 l9_80=param_38;
bool l9_81=param_39;
float3x3 l9_82=param_40;
if (l9_81)
{
...
float2 l9_83=l9_80;
param_38=l9_83;
float l9_84=param_38.x;
int l9_85=param_41.x;
bool l9_86=l9_50;
float l9_87=l9_51;
if ((l9_85==0)||(l9_85==3))
{
...
param_38.x=l9_84;
l9_51=l9_87;
float l9_95=param_38.y;
int l9_96=param_41.y;
bool l9_97=l9_50;
float l9_98=l9_51;
if ((l9_96==0)||(l9_96==3))
{
...
param_38.y=l9_95;
l9_51=l9_98;
float2 l9_106=param_38;
int l9_107=param_36;
int l9_108=param_37;
float l9_109=param_46;
...
float3 l9_115=l9_114;
float4 l9_116=sc_set0.meshData0.sample(sc_set0.meshData0SmpSC,l9_115.xy,bias(l9_109));
float4 l9_117=l9_116;
if (param_44)
{
l9_117=mix(param_45,l9_117,float4(l9_51));
}
float4 l9_118=l9_117;
Color_N33=l9_118;
float3 Output_N9_2=float3(0.0);
float3 param_47=(*sc_set0.UserUniforms).objectBoundsMin;
Output_N9_2=param_47;
float3 Value_N26=float3(0.0);
Value_N26=Output_N9_2;
float Value1_N28=0.0;
float Value2_N28=0.0;
float Value3_N28=0.0;
float3 param_48=Value_N26;
float param_49=param_48.x;
float param_50=param_48.y;
float param_51=param_48.z;
Value1_N28=param_49;
Value2_N28=param_50;
Value3_N28=param_51;
float3 Output_N10_2=float3(0.0);
float3 param_52=(*sc_set0.UserUniforms).objectBoundsMax;
Output_N10_2=param_52;
float3 Value_N27=float3(0.0);
Value_N27=Output_N10_2;
float Value1_N29=0.0;
float Value2_N29=0.0;
float Value3_N29=0.0;
float3 param_53=Value_N27;
float param_54=param_53.x;
float param_55=param_53.y;
float param_56=param_53.z;
Value1_N29=param_54;
Value2_N29=param_55;
Value3_N29=param_56;
float Value1_N30=0.0;
float Value2_N30=0.0;
float4 param_57=Color_N33;
float param_59=Value1_N28;
float param_60=Value1_N29;
float param_62=Value2_N28;
float param_63=Value2_N29;
float2 l9_119=param_57.xy;
float l9_120=param_59;
float l9_121=param_60;
float l9_122=0.99998999;
float2 l9_123=l9_119;
#if (1)
{
l9_123=floor((l9_123*255.0)+float2(0.5))/float2(255.0);
}
#endif
float l9_124=dot(l9_123,float2(1.0,0.0039215689));
float l9_125=l9_124;
float l9_126=0.0;
float l9_127=l9_122;
float l9_128=l9_120;
...
float l9_131=l9_130;
float param_58=l9_131;
float2 l9_132=param_57.zw;
float l9_133=param_62;
float l9_134=param_63;
float l9_135=0.99998999;
float2 l9_136=l9_132;
#if (1)
{
l9_136=floor((l9_136*255.0)+float2(0.5))/float2(255.0);
}
#endif
float l9_137=dot(l9_136,float2(1.0,0.0039215689));
float l9_138=l9_137;
float l9_139=0.0;
float l9_140=l9_135;
float l9_141=l9_133;
...
int l9_150=l9_145;
int param_64=meshData1Layout_tmp;
int param_65=l9_150;
float2 param_66=Output_N38;
bool param_67=(int(SC_USE_UV_TRANSFORM_meshData1_tmp)!=0);
float3x3 param_68=(*sc_set0.UserUniforms).meshData1Transform;
int2 param_69=int2(SC_SOFTWARE_WRAP_MODE_U_meshData1_tmp,SC_SOFTWARE_WRAP_MODE_V_meshData1_tmp);
bool param_70=(int(SC_USE_UV_MIN_MAX_meshData1_tmp)!=0);
float4 param_71=(*sc_set0.UserUniforms).meshData1UvMinMax;
bool param_72=(int(SC_USE_CLAMP_TO_BORDER_meshData1_tmp)!=0);
float4 param_73=(*sc_set0.UserUniforms).meshData1BorderColor;
float param_74=0.0;
bool l9_151=param_72&&(!param_70);
float l9_152=1.0;
float l9_153=param_66.x;
int l9_154=param_69.x;
if (l9_154==1)
{
l9_153=fract(l9_153);
}
...
param_66.x=l9_153;
float l9_158=param_66.y;
int l9_159=param_69.y;
if (l9_159==1)
{
l9_158=fract(l9_158);
}
...
float l9_165=param_66.x;
float l9_166=param_71.x;
float l9_167=param_71.z;
bool l9_168=l9_164;
float l9_169=l9_152;
...
float l9_174=param_66.y;
float l9_175=param_71.y;
float l9_176=param_71.w;
bool l9_177=l9_173;
float l9_178=l9_152;
...
float2 l9_181=param_66;
bool l9_182=param_67;
float3x3 l9_183=param_68;
if (l9_182)
{
...
param_66=l9_184;
float l9_185=param_66.x;
int l9_186=param_69.x;
bool l9_187=l9_151;
float l9_188=l9_152;
...
param_66.x=l9_185;
l9_152=l9_188;
float l9_196=param_66.y;
int l9_197=param_69.y;
bool l9_198=l9_151;
float l9_199=l9_152;
...
param_66.y=l9_196;
l9_152=l9_199;
float2 l9_207=param_66;
int l9_208=param_64;
int l9_209=param_65;
float l9_210=param_74;
...
float4 l9_217=sc_set0.meshData1.sample(sc_set0.meshData1SmpSC,l9_216.xy,bias(l9_210));
float4 l9_218=l9_217;
if (param_72)
{
l9_218=mix(param_73,l9_218,float4(l9_152));
}
float4 l9_219=l9_218;
Color_N34=l9_219;
float Value1_N31=0.0;
float2 param_75=Color_N34.xy;
float param_76=Value3_N28;
float param_77=Value3_N29;
float param_78=0.99998999;
float2 l9_220=param_75;
#if (1)
{
l9_220=floor((l9_220*255.0)+float2(0.5))/float2(255.0);
}
#endif
float l9_221=dot(l9_220,float2(1.0,0.0039215689));
float l9_222=l9_221;
float l9_223=0.0;
float l9_224=param_78;
float l9_225=param_76;
float l9_226=param_77;
float l9_227=l9_225+(((l9_222-l9_223)*(l9_226-l9_225))/(l9_224-l9_223));
float l9_228=l9_227;
Value1_N31=l9_228;
float3 Value_N32=float3(0.0);
Value_N32.x=Value1_N30;
Value_N32.y=Value2_N30;
Value_N32.z=Value1_N31;
float3 Output_N20=float3(0.0);
Output_N20=Value_N19-Value_N32;
float3 ValueOut_N21=float3(0.0);
ValueOut_N21=(((Output_N20-float3((*sc_set0.UserUniforms).Port_RangeMinA_N021))/float3(((*sc_set0.UserUniforms).Port_RangeMaxA_N021-(*sc_set0.UserUniforms).Port_RangeMinA_N021)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N021-(*sc_set0.UserUniforms).Port_RangeMinB_N021))+float3((*sc_set0.UserUniforms).Port_RangeMinB_N021);
float3 Export_N22=float3(0.0);
Export_N22=ValueOut_N21;
FinalColor3=float4(Export_N22,0.0);
float4 param_79=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_229=param_79;
...
{
l9_231=fast::clamp(l9_230.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_231=fast::clamp(dot(l9_230.xyz,float3(l9_230.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_231=(1.0-dot(l9_230.xyz,float3(0.33333001)))*l9_230.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_231=(1.0-fast::clamp(dot(l9_230.xyz,float3(1.0)),0.0,1.0))*l9_230.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_231=fast::clamp(dot(l9_230.xyz,float3(1.0)),0.0,1.0)*l9_230.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_231=fast::clamp(dot(l9_230.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_231=dot(l9_230.xyz,float3(0.33333001))*l9_230.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_231=1.0-fast::clamp(dot(l9_230.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_232=l9_231;
float l9_233=l9_232;
float l9_234=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_233;
float3 l9_235=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_229.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_236=float4(l9_235.x,l9_235.y,l9_235.z,l9_234);
param_79=l9_236;
}
else
{
...
{
param_79=float4(param_79.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_237=param_79;
float4 l9_238=float4(0.0);
float4 l9_239=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_240=out.sc_FragData0;
l9_239=l9_240;
}
else
{
...
float4 l9_277=l9_239;
float3 l9_278=l9_277.xyz;
float3 l9_279=l9_278;
float3 l9_280=l9_237.xyz;
...
l9_238=float4(l9_281.x,l9_281.y,l9_281.z,l9_238.w);
float3 l9_282=mix(l9_278,l9_238.xyz,float3(l9_237.w));
l9_238=float4(l9_282.x,l9_282.y,l9_282.z,l9_238.w);
l9_238.w=1.0;
float4 l9_283=l9_238;
param_79=l9_283;
}
else
{
...
float4 param_80=FinalColor1;
out.sc_FragData1=param_80;
float4 param_81=FinalColor2;
out.sc_FragData2=param_81;
float4 param_82=FinalColor3;
out.sc_FragData3=param_82;
float4 param_83=FinalColor;
FinalColor=sc_OutputMotionVectorIfNeeded(param_83,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_84=FinalColor;
float4 l9_295=param_84;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_295.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_295;
return out;
}
} // FRAGMENT SHADER
