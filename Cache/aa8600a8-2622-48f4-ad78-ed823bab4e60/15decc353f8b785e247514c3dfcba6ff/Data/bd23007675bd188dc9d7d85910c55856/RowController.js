...
let RowController = (() => {
    ...
    var RowController = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.finalCompletionSoundEffect = this.finalCompletionSoundEffect;
        ...
        onAwake() {
            ...
            if (this.rowClearedSoundEffect) {
                try {
                    this.rowClearedSoundEffect.playbackMode = Audio.PlaybackMode?.LowLatency || 1;
            ...
            if (this.finalCompletionSoundEffect) {
                try {
                    this.finalCompletionSoundEffect.playbackMode = Audio.PlaybackMode?.LowLatency || 1;
        ...
        playRowClearedSound() {
            ...
            try {
                ...
                this.rowClearedSoundEffect.play(1);
        ...
        playFinalCompletionSound() {
            if (!this.finalCompletionSoundEffect) {
                return;
            }
            try {
                // Play the sound effect with type assertion to bypass strict typing
                this.finalCompletionSoundEffect.play(1);
        ...
        setFinalCompletionSoundEffect(soundComponent) {
