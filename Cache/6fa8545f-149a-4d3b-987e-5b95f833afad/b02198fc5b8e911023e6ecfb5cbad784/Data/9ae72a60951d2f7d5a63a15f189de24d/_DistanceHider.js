...
var __selfType = requireType("./_DistanceHider");
    ...
    var DistanceHider = _classThis = class extends _classSuper {
        ...
        onAwake() {
            ...
            if (this.collisionSoundEffect) {
                try {
                    this.collisionSoundEffect.playbackMode = Audio.PlaybackMode?.LowLatency || 1;
        ...
        playCollisionSound() {
            ...
            try {
                ...
                this.collisionSoundEffect.play(1);
...
//# sourceMappingURL=_DistanceHider.js.map