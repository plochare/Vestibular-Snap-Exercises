...
//sampler sampler meshData0SmpSC 0:24
//sampler sampler meshData1SmpSC 0:25
...
//texture texture2D meshData0 0:5:0:24
//texture texture2D meshData1 0:6:0:25
...
//float3x3 meshData0Transform 4432
//float4 meshData0UvMinMax 4480
//float4 meshData0BorderColor 4496
//float3x3 meshData1Transform 4560
//float4 meshData1UvMinMax 4608
//float4 meshData1BorderColor 4624
//float depthRef 4640
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_meshData0 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_meshData1 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_meshData0 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_meshData1 80 -1
//spec_const int intensityTextureLayout 81 0
//spec_const int meshData0Layout 82 0
//spec_const int meshData1Layout 83 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_meshData0 [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_meshData1 [[function_constant(77)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_meshData0 [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_meshData1 [[function_constant(80)]];
...
constant int meshData0Layout [[function_constant(82)]];
constant int meshData0Layout_tmp = is_function_constant_defined(meshData0Layout) ? meshData0Layout : 0;
constant int meshData1Layout [[function_constant(83)]];
...
texture2d<float> meshData0 [[id(5)]];
texture2d<float> meshData1 [[id(6)]];
...
sampler meshData0SmpSC [[id(24)]];
sampler meshData1SmpSC [[id(25)]];
...
int l9_6=l9_1;
int param_1=meshData0Layout_tmp;
int param_2=l9_6;
float2 param_3=Globals.Surface_UVCoord0;
bool param_4=(int(SC_USE_UV_TRANSFORM_meshData0_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).meshData0Transform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_meshData0_tmp,SC_SOFTWARE_WRAP_MODE_V_meshData0_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_meshData0_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).meshData0UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_meshData0_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).meshData0BorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.meshData0.sample(sc_set0.meshData0SmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
int l9_84=l9_79;
int param_13=meshData1Layout_tmp;
int param_14=l9_84;
float2 param_15=Globals.Surface_UVCoord0;
bool param_16=(int(SC_USE_UV_TRANSFORM_meshData1_tmp)!=0);
float3x3 param_17=(*sc_set0.UserUniforms).meshData1Transform;
int2 param_18=int2(SC_SOFTWARE_WRAP_MODE_U_meshData1_tmp,SC_SOFTWARE_WRAP_MODE_V_meshData1_tmp);
bool param_19=(int(SC_USE_UV_MIN_MAX_meshData1_tmp)!=0);
float4 param_20=(*sc_set0.UserUniforms).meshData1UvMinMax;
bool param_21=(int(SC_USE_CLAMP_TO_BORDER_meshData1_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).meshData1BorderColor;
float param_23=0.0;
bool l9_85=param_21&&(!param_19);
float l9_86=1.0;
float l9_87=param_15.x;
int l9_88=param_18.x;
if (l9_88==1)
{
l9_87=fract(l9_87);
}
...
param_15.x=l9_87;
float l9_92=param_15.y;
int l9_93=param_18.y;
if (l9_93==1)
{
l9_92=fract(l9_92);
}
...
float l9_99=param_15.x;
float l9_100=param_20.x;
float l9_101=param_20.z;
bool l9_102=l9_98;
float l9_103=l9_86;
...
float l9_108=param_15.y;
float l9_109=param_20.y;
float l9_110=param_20.w;
bool l9_111=l9_107;
float l9_112=l9_86;
...
float2 l9_115=param_15;
bool l9_116=param_16;
float3x3 l9_117=param_17;
if (l9_116)
{
...
param_15=l9_118;
float l9_119=param_15.x;
int l9_120=param_18.x;
bool l9_121=l9_85;
float l9_122=l9_86;
...
param_15.x=l9_119;
l9_86=l9_122;
float l9_130=param_15.y;
int l9_131=param_18.y;
bool l9_132=l9_85;
float l9_133=l9_86;
...
param_15.y=l9_130;
l9_86=l9_133;
float2 l9_141=param_15;
int l9_142=param_13;
int l9_143=param_14;
float l9_144=param_23;
...
float4 l9_151=sc_set0.meshData1.sample(sc_set0.meshData1SmpSC,l9_150.xy,bias(l9_144));
float4 l9_152=l9_151;
if (param_21)
{
l9_152=mix(param_22,l9_152,float4(l9_86));
}
float4 l9_153=l9_152;
Output_N1=l9_153;
FinalColor1=Output_N1;
if ((*sc_set0.UserUniforms).sc_RayTracingCasterConfiguration.x!=0u)
{
...
float4 l9_154=fast::max(param_24,float4(0.0));
float4 param_25=l9_154;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 param_27=FinalColor1;
out.sc_FragData1=param_27;
