...
export class DistanceHiderYZ extends BaseScriptComponent {
    ...
    @input
    detectionDistanceY: number = 2.0;
    
    @input
    detectionDistanceZ: number = 2.0;
