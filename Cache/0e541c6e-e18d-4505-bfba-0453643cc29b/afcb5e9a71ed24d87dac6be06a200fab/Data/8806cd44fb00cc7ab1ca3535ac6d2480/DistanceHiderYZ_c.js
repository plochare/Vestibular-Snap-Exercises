...
// @input float detectionDistanceY = 2
// @input float detectionDistanceZ = 2
...
var Module = require("../../../../Modules/Src/Assets/Scripts/DistanceHiderYZ");
...
awakeEvent.bind(() => {
    ...
    checkUndefined("detectionDistanceY", []);
    checkUndefined("detectionDistanceZ", []);
